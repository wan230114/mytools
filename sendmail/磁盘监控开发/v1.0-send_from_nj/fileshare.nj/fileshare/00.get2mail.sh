...
scp chenjun@192.168.50.5:/ifs/TJPROJ3/Plant/chenjun/software/fileshare/sharedir/log ./sharedir/log &>/dev/null
...
echo -e '天津：' >sendmail.txt
cat sharedir/log >>sendmail.txt
echo -e '南京：' >>sendmail.txt
echo \*\*\*`/NJPROJ2/Plant/chenjun/software/python3.5/python3.5/bin/python3 gettime.py`\*\*\* >>sendmail.txt
echo -e "/NJPROJ1/PAG/Plant/ \n/NJPROJ2/Plant/     \n/NJPROJ3/Plant/     "|xargs -i sh -c """df {}|sort|head -1|awk '{print \$3}'|awk '{if(int(\$0) < 5368709120) print \"{}\t  \"\$0/1024/1024/1024\"T\"}'""" >>sendmail.txt 2>>00.get2mail.sh.log   && echo 02 done. >>00.get2mail.sh.log

/NJPROJ2/Plant/chenjun/software/python3.5/python3.5/bin/python3 sendmail.py &>sendmail.py.log && echo -e "03 done.\n" >>00.get2mail.sh.log
